...
class Player(Moving_Entity):
    ...
    def Save_Data(self):
        super().Save_Data()
        self.saved_data[self.game.keys.souls] = self.souls
    ...
    def Load_Data(self, data):
        ...
        self.souls = data[self.game.keys.souls]
    ...
    def Render(self, surf, offset=(0, 0)):
        ...
        if self.damage_cooldown:
            ...
            self.game.default_font.Render_Word(surf, self.damage_text, (self.pos[0] - offset[0], self.pos[1] - scroll_up_effect - offset[1]), self.game.keys.player_damage_font)
