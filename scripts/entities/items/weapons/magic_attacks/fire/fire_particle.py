...
class Fire_Particle(Projectile):
    def __init__(self, game, pos, shoot_distance):
        super().__init__(game, pos, 'fire_particle', 2, 1, 2, 100, 'particle', 'fire', shoot_distance, 'cut', (10, 10), False)
    ...
    def Set_Enabled(self, pos, speed, special_attack, direction, entity):
        self.disabled = False
