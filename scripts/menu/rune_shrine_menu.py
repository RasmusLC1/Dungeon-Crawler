...
class Rune_Shrine_Menu(Menu):
    ...
    def Init_Rune_Upgrade_Buttons(self):
        ...
        button_size_x = 200
        button_size_y = 40
        self.Generate_Rune_Button((width - button_size_x // 2, 200), (button_size_x, button_size_y), self.game.dictionary.Get_Souls, self.game.dictionary.Get_Souls, (100, 100, 150))
    ...
    def Update_Rune_Buttons(self):
        ...
        for rune_button in self.rune_upgrade_buttons:
            ...
            if self.active_rune.original_soul_cost == 0 and rune_button.effect == self.game.dictionary.Get_Souls:
                continue
