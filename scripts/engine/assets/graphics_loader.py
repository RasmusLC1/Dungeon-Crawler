...
class Graphics_Loader:
    ...
    def Asset_Potion_List(self):
        ...
        potion_assets = {
            ...
            'invisibility_full' : get_tiles_from_sheet('Potions/invisibility/invisibility.png', 2, 2, 0, 0, 32, 32,),
            'invisibility_half' : get_tiles_from_sheet('Potions/invisibility/invisibility.png', 2, 2, 0, 0, 32, 32,),
            'invisibility_low' : get_tiles_from_sheet('Potions/invisibility/invisibility.png', 2, 2, 0, 0, 32, 32,),
            ...
            'increase_souls_full' : get_tiles_from_sheet('Potions/soul_potions/soul_full.png', 2, 2, 0, 0, 32, 32,),
            'increase_souls_half' : get_tiles_from_sheet('Potions/soul_potions/soul_half.png', 2, 2, 0, 0, 32, 32,),
            'increase_souls_low' : get_tiles_from_sheet('Potions/soul_potions/soul_low.png', 2, 2, 0, 0, 32, 32,),

            'arcane_hunger_full' : get_tiles_from_sheet('Potions/soul_potions/arcane_hunger_full.png', 2, 2, 0, 0, 32, 32,),
            'arcane_hunger_half' : get_tiles_from_sheet('Potions/soul_potions/arcane_hunger_half.png', 2, 2, 0, 0, 32, 32,),
            'arcane_hunger_low' : get_tiles_from_sheet('Potions/soul_potions/arcane_hunger_low.png', 2, 2, 0, 0, 32, 32,),
    ...
    def Asset_Rune(self):
        rune = {
            ...
            'arcane_hunger_rune' : get_tiles_from_sheet('runes/hunger_rune.png', 1, 0, 0, 0, 32, 32),
    ...
    def Asset_Font(self):
        font = {
            ...
            'small_font' : get_tiles_from_sheet('font/small_font.png', 7, 5, 0, 0, 8, 8),
