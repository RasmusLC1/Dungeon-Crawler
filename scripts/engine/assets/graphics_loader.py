...
class Graphics_Loader:
    ...
    def Asset_Interative_Objects_List(self):
        ...
        Objects_assets = {
            ...
            'Door_Basic' : get_tiles_from_sheet('decoration/door/door_closed.png', 0, 0, 0, 0, 16, 16),
    ...
    def Asset_Rune(self):
        rune = {
            ...
            'regen_rune' : get_tiles_from_sheet('runes/regen_rune.png', 1, 0, 0, 0, 16, 16),
            ...
            'fire_cirlce_rune' : get_tiles_from_sheet('runes/fire_rune_cirlce.png', 1, 0, 0, 0, 16, 16),
            'fire_resistance_rune' : get_tiles_from_sheet('runes/fire_rune_resistance.png', 1, 0, 0, 0, 16, 16),
            'fire_shield_rune' : get_tiles_from_sheet('runes/fire_rune_shield.png', 1, 0, 0, 0, 16, 16),
            'fire_spray_rune' : get_tiles_from_sheet('runes/fire_rune_spray.png', 1, 0, 0, 0, 16, 16),
            'freeze_circle_rune' : get_tiles_from_sheet('runes/frost_rune_circle.png', 1, 0, 0, 0, 16, 16),
            'freeze_resistance_rune' : get_tiles_from_sheet('runes/frost_rune_resistance.png', 1, 0, 0, 0, 16, 16),
            'freeze_shield_rune' : get_tiles_from_sheet('runes/frost_rune_shield.png', 1, 0, 0, 0, 16, 16),
            'freeze_spray_rune' : get_tiles_from_sheet('runes/frost_rune_spray.png', 1, 0, 0, 0, 16, 16),
            ...
            'resistance_rune' : get_tiles_from_sheet('runes/resistance_rune.png', 1, 0, 0, 0, 16, 16),
            'shield_rune' : get_tiles_from_sheet('runes/shield_rune.png', 1, 0, 0, 0, 16, 16),
            'silence_rune' : get_tiles_from_sheet('runes/silence_rune.png', 1, 0, 0, 0, 16, 16),
            'speed_rune' : get_tiles_from_sheet('runes/speed_rune.png', 1, 0, 0, 0, 16, 16),
            'strength_rune' : get_tiles_from_sheet('runes/strength_rune.png', 1, 0, 0, 0, 16, 16),
            'vampiric_rune' : get_tiles_from_sheet('runes/vampiric_rune.png', 1, 0, 0, 0, 16, 16),
        }
