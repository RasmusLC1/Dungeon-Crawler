...
class Graphics_Loader:
    ...
    def Asset_Rune(self):
        rune = {
            ...
            'frost_circle_rune' : get_tiles_from_sheet('runes/frost_rune_circle.png', 1, 0, 0, 0, 16, 16),
            'frost_resistance_rune' : get_tiles_from_sheet('runes/frost_rune_resistance.png', 1, 0, 0, 0, 16, 16),
            'frost_shield_rune' : get_tiles_from_sheet('runes/frost_rune_shield.png', 1, 0, 0, 0, 16, 16),
            'frost_spray_rune' : get_tiles_from_sheet('runes/frost_rune_spray.png', 1, 0, 0, 0, 16, 16),
