...
class Graphics_Loader:
    ...
    def Asset_Trap_List(self):
        ...
        trap_assets = {
            ...
            self.keys.spider_web : get_tiles_from_sheet('entities/enemies/spider/spider_web.png', 3, 0, 0, 0, 32, 32),
            self.keys.poison_plume : get_tiles_from_sheet('traps/poison_plume.png', 7, 0, 0, 0, 32, 32),
        }
    ...
    def Asset_Effect_List(self):
        ...
        effect_assets = {
            ...
            self.keys.fire : get_tiles_from_sheet('particles/effects/fire/orange/loops/burning_loop_1.png', 7, 0, 0, 0, 32, 32, white),
            self.keys.poison : get_tiles_from_sheet('particles/effects/poison.png', 2, 0, 0, 0, 32, 32, white),
            self.keys.frozen : get_tiles_from_sheet('particles/effects/frozen.png', 2, 0, 0, 0, 32, 32, white),
            self.keys.wet : get_tiles_from_sheet('particles/effects/wet.png', 2, 0, 0, 0, 32, 32),
            self.keys.regen : get_tiles_from_sheet('particles/effects/regen.png', 2, 1, 0, 0, 32, 32),
            self.keys.electric : get_tiles_from_sheet('particles/effects/electric.png', 5, 0, 0, 0, 32, 32),
            self.keys.invincible : get_tiles_from_sheet('particles/effects/invincible.png', 6, 0, 0, 0, 32, 32),
        }
        self.assets.update(effect_assets)
    ...
    def Asset_Environment_List(self):
        Environment_assets = {
            ...
            self.keys.shallow_water_env: get_tiles_from_sheet('environment/water.png', 2, 0, 32, 0, 32, 32),
            ...
            self.keys.shallow_ice_env: get_tiles_from_sheet('environment/water.png', 1, 0, 112, 0, 32, 32),
