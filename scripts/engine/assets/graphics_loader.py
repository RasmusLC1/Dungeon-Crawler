...
class Graphics_Loader:
    ...
    def Asset_Rune(self):
        rune = {
            ...
            'fire_rune_spray' : get_tiles_from_sheet('runes/fire_rune_spray.png', 1, 0, 0, 0, 16, 16),
            'frost_rune_circle' : get_tiles_from_sheet('runes/frost_rune_circle.png', 1, 0, 0, 0, 16, 16),
