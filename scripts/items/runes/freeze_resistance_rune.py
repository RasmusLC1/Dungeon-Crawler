...
class Freeze_Resistance_Rune(Rune):
    def __init__(self, game, pos):
        super().__init__(game, 'freeze_resistance_rune', pos, 5, 5)
    ...
    def Render_Animation(self, surf, offset=(0, 0)):
        ...
        alpha = 60
        pygame.draw.circle(temp_surf, (0, 0, 255, alpha), (inversed_animation_size, inversed_animation_size), inversed_animation_size)
