...
from scripts.items.weapons.magic_attacks.poison.poison_ball import Poison_Ball
import math
import pygame

class Poison_Ball_Rune(Rune):
    def __init__(self, game, pos):
        super().__init__(game, 'poison_ball_rune', pos, 4, 20)
