...
class Rune_Handler():
    ...
    def Rune_Spawner(self, name, data = None):
        ...
        elif 'frozen_resistance' == name:
            rune = self.Init_Frozen_Resistance_Rune()
        elif 'key' == name:
    ...
    def Init_Frozen_Resistance_Rune(self):
        return Frozen_Resistance_Rune(self.game, (9999, 9999))
    ...
    def Poison_Ball_Rune(self):
        return Poison_Ball_Rune(self.game, (9999, 9999))
