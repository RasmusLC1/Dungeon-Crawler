...
{'game': <__main__.Game object at 0x0000024B9C44BF10>, 'ID': 7363223, 'category': 'item', 'sub_category': 'weapon', 'type': 'warhammer', 'pos': (3228.464407676389, 1474.4906243412775), 'size': (32, 32), 'active': 699, 'light_level': 75, 'render': False, 'tile': '100;46', 'saved_data': {}, 'text_box': <scripts.entities.textbox.weapon_textbox.Weapon_Textbox object at 0x0000024BBD3D9C90>, 'sub_type': 'warhammer', 'used': False, 'picked_up': True, 'move_inventory_slot': False, 'inventory_type': 'left_hand', 'inventory_index': 0, 'activate_cooldown': 0, 'animation_cooldown': 7, 'animation_cooldown_max': 50, 'amount': 1, 'max_amount': 0, 'max_animation': 5, 'animation': 4, 'nearby_entities': [], 'delete_countdown': 0, 'value': 100, 'is_projectile': False, 'damage': 9, 'speed': 8, 'range': 6, 'entity': <scripts.entities.moving_entities.player.player.Player object at 0x0000024BB5F78D00>, 'effect': 'blunt', 'attack_type': 'cut', 'in_inventory': True, 'equipped': True, 'attacking': 
0, 'flip_x': False, 'attack_animation': 0, 'attack_animation_max': 5, 'special_attack_effect_animation_max': 5, 'attack_animation_time': 0, 'attack_animation_counter': 0, 'attack_effect_animation': 0, 'attack_effect_animation_max': 6, 'attack_effect_animation_time': 0, 'attack_effect_animation_counter': 0, 'enemy_hit': False, 'rotate': 0, 'nearby_enemies': [], 'weapon_class': 'two_handed_melee', 'charge_time': 0, 'max_charge_time': 80, 'is_charging': 0, 'special_attack': 0, 'special_attack_active': False, 'charge_effect': 'blunt_charge_effect', 'charge_effect_animation': 0, 'charge_effect_animation_max': 5, 'charge_effect_cooldown': 0, 'charge_effect_cooldown_max': 12, 'weapon_cooldown': 0, 'weapon_cooldown_max': 50, 'delete_timer': 0, 'attack_hitbox_size': (5, 5), 'attack_hitbox': <rect(3228, 1489, 5, 5)>}