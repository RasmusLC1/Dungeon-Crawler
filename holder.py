...
class Light():
    ...
    def Compute_Angles(self):
        self.angle_cosines = [math.cos(math.radians(i * (self.field_of_view / self.number_rays))) for i in range(self.light_level)]
        self.angle_sines = [math.sin(math.radians(i * (self.field_of_view / self.number_rays))) for i in range(self.light_level)]
