...
class Editor:
    ...
    def run(self):
        while True:
            ...
            offgrid_list = ['spawners', 'enemies' 'TopPush', 'chest', 'BearTrap', keys.fire_trap, 'spike_poison', 'torch', keys.spider_web]
            ...
            if self.clicking and self.ongrid:
                if (self.tile_list[self.tile_group] in offgrid_list):
                    ...
                    self.ongrid = True
                    self.tilemap.tilemap[str(tile_pos[0]) + ';' + str(tile_pos[1])] = {'type': self.tile_list[self.tile_group], 'variant': self.tile_variant, 'pos': tile_pos, 'active': 0, 'light': 0}
